...
export default function AddNoteModal({
  ...
  const handleSubmit = () => {
    setIsLoading(true);
    correction.status = option === "approve" ? "APPROVED" : "REJECTED";
    console.log(correction, note);
    authFetch
      .put(`/correction/updateStatus/${correction.id}`, {
        attendanceCorrection: correction,
        addNote: note,
        requestEmployeeId: correction.employeeId,
      })
      .then((res) => {
        // console.log(res.data);
        displayAlert("Correction request updated successfully", "success");
        setIsLoading(false);
        handleClose();
